<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quimica.aspx.cs" Inherits="_Default" %>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                <div class="intro-left tm-bg-dark">
                  <h2 class="mb-4">bienvenido a la Carrera de Quimica</h2>
                  <p class="mb-4">
                    
                  La carrera de <a rel="sponsored" href="https://www.fcpn.edu.bo/" target="_blank">Quimica</a> 
            ...
            <div class="mx-auto position-relative gallery-container">
              ...
              <div class="mx-auto tm-border-top gallery-slider">
                ...
                <figure class="effect-julia item">
                    ...
                    <figcaption>
                        <div>
                            <p>centro de estudiantes  de Quimica</p>
                        </div>
                        <a href="#">View more</a>
                    </figcaption>
                </figure>
